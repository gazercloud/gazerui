...
type ListView struct {
	...
	showingTime     *uievents.FormTimer
}
...
func NewListView(parent uiinterfaces.Widget) *ListView {
	...
	c.cellPadding = 0
	c.panelPadding = 0
	c.cache = ui.NewImageCache("ListView")
	c.itemHeight = 25
	c.contentPadding = 3
...
func (c *ListViewContent) drawItem(ctx ui.DrawContext, item *ListViewItem, y int, itemIndex int) int {
	yOffset := 0
...
func (c *ListViewContent) drawGrid(ctx ui.DrawContext) {
	xOffset := 0
